...
- **Formatter not enforced:** running `ruff format` over the codebase would rewrite most files for no functional gain at this stage. Lint is enforced; formatting can be adopted later in one dedicated commit.
